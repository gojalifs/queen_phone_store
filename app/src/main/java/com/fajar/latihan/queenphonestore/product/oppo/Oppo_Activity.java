...
import com.fajar.latihan.queenphonestore.product.huawei.Huawei_Phone;

import java.util.ArrayList;

public class Oppo_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listOFProduct.addAll(Huawei_Phone.getHuaweiPhoneList());
