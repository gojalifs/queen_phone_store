...
public class Iphone_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView = findViewById(R.id.tv_nyobatext);
        ...
        listOFProduct.addAll(Iphone_Phone.getIphonePhoneList());
